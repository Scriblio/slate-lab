...
if __name__ == "__main__":
    ...
    print("  never-seen inputs, from single-digit-rule lessons. Capability moves")
    print("  through pure memory when distilled as composable steps + feedback,")
    print("  not as examples. The distill.py wall was about the FORMAT of the")
    print("  lesson, not a limit of the substrate.")
